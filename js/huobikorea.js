...
module.exports = class huobikorea extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'hostname': 'api-cloud.huobi.co.kr', // api.testnet.huobi.pro
            'pro': true,
            'has': {
                'CORS': false,
                'fetchTickers': true,
            ...
            'urls': {
                ...
                'referral': 'https://www.huobi.co.kr/maid/maidRank?invite_code=2d554',
                'doc': 'https://alphaex-api.github.io/openapi/spot/v1/kr/#fa255f0ccc',
                'fees': 'https://support.huobi.co.kr/hc/ko/articles/360002213031-수수료-안내',
            },
            'api': {
                'v2Public': {
                    'get': [
